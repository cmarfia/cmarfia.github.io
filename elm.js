...
{
	if (region.Y.F === region.aj.F)
	{
		return 'on line ' + region.Y.F;
	}
	return 'on lines ' + region.Y.F + ' through ' + region.aj.F;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aS: 'hidden', E: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aS: 'mozHidden', E: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aS: 'msHidden', E: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aS: 'webkitHidden', E: 'webkitvisibilitychange' }
		: { aS: 'hidden', E: 'visibilitychange' };
}
...
var author$project$Main$GotStoryMsg = function (a) {
	return {$: 6, a: a};
};
...
var author$project$Main$updateModelWith = F2(
	function (model, _n0) {
		var page = _n0.a;
		var cmds = _n0.b;
...
var author$project$Main$updatePageWith = F3(
	function (toPage, toMsg, _n0) {
		var subModel = _n0.a;
		var subCmd = _n0.b;
		return _Utils_Tuple2(
			toPage(subModel),
...
var author$project$Port$PreloadImages = function (a) {
	return {$: 0, a: a};
};
...
var author$project$Port$encode = function (msg) {
	if (!msg.$) {
		var images = msg.a;
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'command',
					elm$json$Json$Encode$string('PRELOAD_IMAGES')),
					_Utils_Tuple2(
					'data',
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'command',
					elm$json$Json$Encode$string('SPEAK')),
					_Utils_Tuple2(
					'data',
...
var author$project$Story$Components$addComponent = F3(
...
var author$project$Story$Components$addImage = function (url) {
	return A2(
		...
		'image',
		author$project$Story$Components$Image(url));
};
var author$project$Story$Components$Name = function (a) {
	return {$: 0, a: a};
};
var author$project$Story$Components$addName = function (name) {
	return A2(
		author$project$Story$Components$addComponent,
		'name',
		author$project$Story$Components$Name(name));
};
...
var author$project$Story$Components$addNarrative = function (narrative) {
	return A2(
		author$project$Story$Components$addComponent,
		'narrative',
		author$project$Story$Components$Narrative(narrative));
};
var author$project$Story$Components$RuleData = function (a) {
	return {$: 5, a: a};
};
var author$project$Story$Components$addRuleData = function (ruleData) {
	return A2(
		author$project$Story$Components$addComponent,
		'ruleData',
		author$project$Story$Components$RuleData(ruleData));
};
var author$project$Story$Components$createRule = F3(
	function (id, ruleData, narrative) {
		return A2(
			author$project$Story$Components$addNarrative,
			narrative,
			A2(
				author$project$Story$Components$addRuleData,
				ruleData,
...
var author$project$Story$HowJaraldandTenzinMet$Narrative$jaraldHearsASounds = 'A giraffe named Jarald was walking through that forest on his way to a mightly castle.\n\nJust when everything seems calm Jarald heard a noise. "What was that" cried Jarald.';
...
var jschomay$elm_narrative_engine$Types$CharacterIsInLocation = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var author$project$Story$HowJaraldandTenzinMet$StoryInfo$storyInfo = {
	ag: 'https://via.placeholder.com/150x200?text=How Jarald and Tenzin Met',
	aT: _List_fromArray(
		['/img/giraffe.png', '/img/panda.png', '/img/forest.png', '/img/castle.png']),
	aZ: {af: author$project$Story$HowJaraldandTenzinMet$Manifest$characters, an: author$project$Story$HowJaraldandTenzinMet$Manifest$items, ar: author$project$Story$HowJaraldandTenzinMet$Manifest$locations},
...
var author$project$Story$TheAdventuresOfLaz$StoryInfo$storyInfo = {
	ag: 'https://via.placeholder.com/150x200?text=The Adventures of Laz The Cat',
	aT: _List_fromArray(
		['/img/laz.png', '/img/forest.png']),
	aZ: {af: author$project$Story$TheAdventuresOfLaz$Manifest$characters, an: author$project$Story$TheAdventuresOfLaz$Manifest$items, ar: author$project$Story$TheAdventuresOfLaz$Manifest$locations},
	...
	ab: 'The Adventures Of Laz The Cat'
};
...
var author$project$Page$Home$init = function () {
	...
	return _Utils_Tuple2(
		{_: author$project$Story$AllStories$allStories},
...
var author$project$Story$Components$getNarrative = F2(
	function (id, components) {
		var _n0 = A2(elm$core$Dict$get, 'narrative', components);
		if ((!_n0.$) && (_n0.a.$ === 4)) {
			var narrative = _n0.a.a;
			return narrative;
		} else {
			return id;
		}
	});
var author$project$Story$Components$getRuleData = F2(
	function (id, components) {
		var _n0 = A2(elm$core$Dict$get, 'ruleData', components);
		if ((!_n0.$) && (_n0.a.$ === 5)) {
			var rule = _n0.a.a;
			return rule;
		} else {
			return {
				aL: _List_Nil,
				aM: _List_Nil,
				aY: jschomay$elm_narrative_engine$Engine$with('')
			};
		}
	});
...
var jschomay$elm_narrative_engine$Types$Location = function (a) {
	return {$: 1, a: a};
};
var jschomay$elm_narrative_engine$Engine$Manifest$addLocation = function (interactable) {
	if ((!interactable.$) && (interactable.a.$ === 1)) {
		return elm$core$Maybe$Just(
			jschomay$elm_narrative_engine$Types$Location(true));
	} else {
		return interactable;
	}
};
var jschomay$elm_narrative_engine$Types$Character = function (a) {
	return {$: 2, a: a};
};
var jschomay$elm_narrative_engine$Types$CharacterOffScreen = {$: 1};
var jschomay$elm_narrative_engine$Engine$Manifest$moveCharacterOffScreen = function (interactable) {
	if ((!interactable.$) && (interactable.a.$ === 2)) {
		return elm$core$Maybe$Just(
			jschomay$elm_narrative_engine$Types$Character(jschomay$elm_narrative_engine$Types$CharacterOffScreen));
	} else {
		return interactable;
	}
};
var jschomay$elm_narrative_engine$Types$CharacterInLocation = function (a) {
	return {$: 0, a: a};
};
var jschomay$elm_narrative_engine$Engine$Manifest$moveCharacterToLocation = F2(
	function (locationId, interactable) {
		if ((!interactable.$) && (interactable.a.$ === 2)) {
			return elm$core$Maybe$Just(
				jschomay$elm_narrative_engine$Types$Character(
					jschomay$elm_narrative_engine$Types$CharacterInLocation(locationId)));
		} else {
			return interactable;
		}
	});
var jschomay$elm_narrative_engine$Types$Item = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var jschomay$elm_narrative_engine$Types$ItemOffScreen = {$: 2};
var jschomay$elm_narrative_engine$Engine$Manifest$moveItemOffScreen = function (interactable) {
	if ((!interactable.$) && (!interactable.a.$)) {
		var _n1 = interactable.a;
		return elm$core$Maybe$Just(
			A2(jschomay$elm_narrative_engine$Types$Item, false, jschomay$elm_narrative_engine$Types$ItemOffScreen));
	} else {
		return interactable;
	}
};
var jschomay$elm_narrative_engine$Types$ItemInInventory = {$: 1};
var jschomay$elm_narrative_engine$Engine$Manifest$moveItemToInventory = function (interactable) {
	if (((!interactable.$) && (!interactable.a.$)) && (!interactable.a.a)) {
		var _n1 = interactable.a;
		return elm$core$Maybe$Just(
			A2(jschomay$elm_narrative_engine$Types$Item, false, jschomay$elm_narrative_engine$Types$ItemInInventory));
	} else {
		return interactable;
	}
};
var jschomay$elm_narrative_engine$Types$ItemInLocation = function (a) {
	return {$: 0, a: a};
};
var jschomay$elm_narrative_engine$Engine$Manifest$moveItemToLocation = F2(
	function (locationId, interactable) {
		if ((!interactable.$) && (!interactable.a.$)) {
			var _n1 = interactable.a;
			return elm$core$Maybe$Just(
				A2(
					jschomay$elm_narrative_engine$Types$Item,
					false,
					jschomay$elm_narrative_engine$Types$ItemInLocation(locationId)));
		} else {
			return interactable;
		}
	});
var jschomay$elm_narrative_engine$Engine$Manifest$moveItemToLocationFixed = F2(
	function (locationId, interactable) {
		if ((!interactable.$) && (!interactable.a.$)) {
			var _n1 = interactable.a;
			return elm$core$Maybe$Just(
...
var jschomay$elm_narrative_engine$Engine$Manifest$removeLocation = function (interactable) {
	if ((!interactable.$) && (interactable.a.$ === 1)) {
		return elm$core$Maybe$Just(
			jschomay$elm_narrative_engine$Types$Location(false));
	} else {
		return interactable;
	}
};
var jschomay$elm_narrative_engine$Engine$Manifest$update = F2(
	function (change, manifest) {
		switch (change.$) {
			case 0:
				var id = change.a;
				return A3(elm$core$Dict$update, id, jschomay$elm_narrative_engine$Engine$Manifest$addLocation, manifest);
			case 1:
				var id = change.a;
				return A3(elm$core$Dict$update, id, jschomay$elm_narrative_engine$Engine$Manifest$addLocation, manifest);
			case 2:
				var id = change.a;
				return A3(elm$core$Dict$update, id, jschomay$elm_narrative_engine$Engine$Manifest$removeLocation, manifest);
			case 5:
				var id = change.a;
				return A3(elm$core$Dict$update, id, jschomay$elm_narrative_engine$Engine$Manifest$moveItemToInventory, manifest);
			case 4:
				var itemId = change.a;
				...
				return A3(
					...
					itemId,
					jschomay$elm_narrative_engine$Engine$Manifest$moveItemToLocation(locationId),
					manifest);
			case 3:
				var itemId = change.a;
				var locationId = change.b;
				return A3(
					elm$core$Dict$update,
					itemId,
					jschomay$elm_narrative_engine$Engine$Manifest$moveItemToLocationFixed(locationId),
					manifest);
			case 6:
				var id = change.a;
				return A3(elm$core$Dict$update, id, jschomay$elm_narrative_engine$Engine$Manifest$moveItemOffScreen, manifest);
			case 7:
				...
				return A3(
					elm$core$Dict$update,
					characterId,
					jschomay$elm_narrative_engine$Engine$Manifest$moveCharacterToLocation(locationId),
					manifest);
			case 8:
				var id = change.a;
				return A3(elm$core$Dict$update, id, jschomay$elm_narrative_engine$Engine$Manifest$moveCharacterOffScreen, manifest);
			default:
				return manifest;
		}
	});
var jschomay$elm_narrative_engine$Engine$changeWorld = F2(
	function (changes, _n0) {
		var story = _n0;
		var doChange = F2(
			function (change, story_) {
				switch (change.$) {
					case 0:
					...
					case 10:
						...
						return _Utils_update(
							story_,
							{
								aa: elm$core$Maybe$Just(ending)
							});
					default:
						return _Utils_update(
							story_,
							{
								aZ: A2(jschomay$elm_narrative_engine$Engine$Manifest$update, change, story_.aZ)
							});
				}
			});
		return A3(elm$core$List$foldr, doChange, story, changes);
	});
var jschomay$elm_narrative_engine$Engine$Manifest$character = jschomay$elm_narrative_engine$Types$Character(jschomay$elm_narrative_engine$Types$CharacterOffScreen);
...
var jschomay$elm_narrative_engine$Engine$Manifest$init = function (_n0) {
	...
	return A3(
		foldFn,
		jschomay$elm_narrative_engine$Engine$Manifest$character,
		characters,
		A3(
			foldFn,
			jschomay$elm_narrative_engine$Engine$Manifest$location,
			locations,
			A3(foldFn, jschomay$elm_narrative_engine$Engine$Manifest$item, items, elm$core$Dict$empty)));
};
...
var author$project$Page$Story$init = function (story) {
	var rules = author$project$Story$getRules(story);
	var manifest = author$project$Story$getManifest(story);
	var loadImagesMsg = author$project$Port$PreloadImages(
		author$project$Story$getImagesToPreload(story));
	var engineModel = A2(
		jschomay$elm_narrative_engine$Engine$changeWorld,
		author$project$Story$getStartingState(story),
		A2(
			jschomay$elm_narrative_engine$Engine$init,
			{
				af: A2(elm$core$List$map, elm$core$Tuple$first, manifest.af),
				an: A2(elm$core$List$map, elm$core$Tuple$first, manifest.an),
				ar: A2(elm$core$List$map, elm$core$Tuple$first, manifest.ar)
			},
			A2(elm$core$Dict$map, author$project$Story$Components$getRuleData, rules)));
	return _Utils_Tuple2(
		{
			i: engineModel,
			V: A2(elm$core$Dict$map, author$project$Story$Components$getNarrative, rules),
			A: story,
			h: _List_fromArray(
				[
		...
		if (maybeRoute.$ === 1) {
			...
			if (!maybeRoute.a.$) {
				...
				return A2(
					author$project$Main$updateModelWith,
					model,
					A3(author$project$Main$updatePageWith, author$project$Main$Home, author$project$Main$GotHomeMsg, author$project$Page$Home$init));
			} else {
				var story = maybeRoute.a.a;
				return A2(
					author$project$Main$updateModelWith,
					model,
					A3(
						...
						author$project$Page$Story$init(story)));
			}
		}
	});
...
var author$project$Story$Story = elm$core$Basics$identity;
var elm$url$Url$Parser$Parser = elm$core$Basics$identity;
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {p: frag, r: params, o: unvisited, k: value, s: visited};
	});
...
var author$project$Story$parser = function () {
	var toParser = function (storyInfo) {
		return A2(
			elm$url$Url$Parser$map,
			storyInfo,
			elm$url$Url$Parser$s(storyInfo.a5));
	};
...
var author$project$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(elm$url$Url$Parser$map, author$project$Route$Story, author$project$Story$parser)
		]));
	...
	return A2(
		...
		_Utils_update(
			url,
			{
				...
				a2: A2(elm$core$Maybe$withDefault, '', url.aR)
			}));
};
...
var author$project$Port$fromJavaScript = _Platform_incomingPort('fromJavaScript', elm$json$Json$Decode$value);
var author$project$Main$subscriptions = function (_n0) {
	return author$project$Port$fromJavaScript(author$project$Main$GotSubscription);
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aR: fragment, am: host, a2: path, av: port_, ay: protocol, az: query};
	});
...
var author$project$Page$Home$update = F3(
	function (navKey, msg, model) {
		...
		return _Utils_Tuple2(
			model,
			A2(elm$browser$Browser$Navigation$pushUrl, navKey, url));
	});
...
var author$project$Port$Speak = function (a) {
	return {$: 1, a: a};
};
...
var author$project$Story$Components$findEntity = F2(
		...
		return A2(
			...
			elm$core$List$head(
				A2(
					...
					_Utils_ap(
						manifest.an,
						_Utils_ap(manifest.ar, manifest.af)))));
	});
...
var jschomay$elm_narrative_engine$Engine$Manifest$isItem = F2(
...
var jschomay$elm_narrative_engine$Engine$Manifest$isLocation = F2(
	function (id, manifest) {
		return function (interactable) {
			if ((!interactable.$) && (interactable.a.$ === 1)) {
				return true;
...
var jschomay$elm_narrative_engine$Engine$Rules$bestMatch = F2(
	function (heuristics, matchingRules) {
		return elm$core$List$head(
			elm$core$List$reverse(
				A2(
					elm$core$List$sortBy,
					A2(elm$core$Basics$composeR, elm$core$Tuple$second, heuristics),
					matchingRules)));
	});
...
var jschomay$elm_narrative_engine$Engine$Manifest$getCharactersInLocation = F2(
	function (locationId, manifest) {
		var isInLocation = function (_n1) {
			var id = _n1.a;
			var interactable = _n1.b;
			if ((interactable.$ === 2) && (!interactable.a.$)) {
				var location_ = interactable.a.a;
				return _Utils_eq(location_, locationId) ? elm$core$Maybe$Just(id) : elm$core$Maybe$Nothing;
			} else {
				return elm$core$Maybe$Nothing;
			}
		};
...
var jschomay$elm_narrative_engine$Engine$Manifest$characterIsInLocation = F3(
	function (character_, currentLocation, manifest) {
		return A2(
			elm$core$List$any,
			elm$core$Basics$eq(character_),
			A2(jschomay$elm_narrative_engine$Engine$Manifest$getCharactersInLocation, currentLocation, manifest));
	});
var jschomay$elm_narrative_engine$Engine$Manifest$getItemsInInventory = function (manifest) {
	var isInInventory = function (_n2) {
		var id = _n2.a;
		var interactable = _n2.b;
		if ((!interactable.$) && (interactable.b.$ === 1)) {
			var _n1 = interactable.b;
...
var jschomay$elm_narrative_engine$Engine$Manifest$itemIsInInventory = F2(
	function (id, manifest) {
		return A2(
			elm$core$List$any,
			elm$core$Basics$eq(id),
			jschomay$elm_narrative_engine$Engine$Manifest$getItemsInInventory(manifest));
	});
var jschomay$elm_narrative_engine$Engine$Manifest$getItemsInLocation = F2(
	function (locationId, manifest) {
		var isInLocation = function (_n1) {
			var id = _n1.a;
			var interactable = _n1.b;
			if ((!interactable.$) && (!interactable.b.$)) {
				var location_ = interactable.b.a;
				return _Utils_eq(location_, locationId) ? elm$core$Maybe$Just(id) : elm$core$Maybe$Nothing;
			} else {
				return elm$core$Maybe$Nothing;
			}
...
var jschomay$elm_narrative_engine$Engine$Manifest$itemIsInLocation = F3(
	function (item_, currentLocation, manifest) {
		return A2(
			elm$core$List$any,
			elm$core$Basics$eq(item_),
			A2(jschomay$elm_narrative_engine$Engine$Manifest$getItemsInLocation, currentLocation, manifest));
	});
	...
	function (_n0, condition) {
		...
		switch (condition.$) {
			case 0:
				...
				return A2(jschomay$elm_narrative_engine$Engine$Manifest$itemIsInInventory, item, manifest);
			case 1:
				var character = condition.a;
				var location = condition.b;
				return A3(jschomay$elm_narrative_engine$Engine$Manifest$characterIsInLocation, character, location, manifest);
			case 5:
				var item = condition.a;
				var location = condition.b;
				return A3(jschomay$elm_narrative_engine$Engine$Manifest$itemIsInLocation, item, location, manifest);
			case 3:
			...
			case 8:
				var id = condition.a;
				return A2(elm$core$List$member, id, history);
			case 9:
				var id = condition.a;
				return !A2(elm$core$List$member, id, history);
			default:
...
var jschomay$elm_narrative_engine$Engine$Manifest$isCharacter = F2(
	function (id, manifest) {
		return function (interactable) {
			if ((!interactable.$) && (interactable.a.$ === 2)) {
				return true;
...
var jschomay$elm_narrative_engine$Engine$Rules$matchesInteraction = F3(
	function (manifest, interactionMatcher, interactableId) {
		switch (interactionMatcher.$) {
			case 0:
				return true;
			case 1:
				return A2(jschomay$elm_narrative_engine$Engine$Manifest$isItem, interactableId, manifest);
			case 2:
				return A2(jschomay$elm_narrative_engine$Engine$Manifest$isLocation, interactableId, manifest);
			case 3:
				return A2(jschomay$elm_narrative_engine$Engine$Manifest$isCharacter, interactableId, manifest);
			default:
...
var jschomay$elm_narrative_engine$Engine$Rules$sceneConstraintWeight = function (rule) {
	...
	return A2(elm$core$List$any, hasSceneConstraints, rule.aM) ? 300 : 0;
};
...
var jschomay$elm_narrative_engine$Engine$Rules$tallyWith = F3(
	function (f1, f2, a) {
		return f1(a) + f2(a);
	});
var jschomay$elm_narrative_engine$Engine$Rules$findMatchingRule = F2(
	function (story, interactableId) {
		return A2(
			jschomay$elm_narrative_engine$Engine$Rules$bestMatch,
			A2(
				jschomay$elm_narrative_engine$Engine$Rules$tallyWith,
				jschomay$elm_narrative_engine$Engine$Rules$specificityWeight,
				A2(jschomay$elm_narrative_engine$Engine$Rules$tallyWith, jschomay$elm_narrative_engine$Engine$Rules$sceneConstraintWeight, jschomay$elm_narrative_engine$Engine$Rules$numConstrictionsWeight)),
			A2(
				elm$core$List$filter,
				A2(
					elm$core$Basics$composeR,
...
var jschomay$elm_narrative_engine$Engine$update = F2(
	function (interactableId, model) {
		...
		var defaultChanges = A2(jschomay$elm_narrative_engine$Engine$Manifest$isLocation, interactableId, story.aZ) ? _List_fromArray(
			[
				jschomay$elm_narrative_engine$Types$MoveTo(interactableId)
			]) : (A2(jschomay$elm_narrative_engine$Engine$Manifest$isItem, interactableId, story.aZ) ? _List_fromArray(
			[
	...
	function (navKey, msg, model) {
		switch (msg.$) {
			case 0:
				...
				var _n1 = A2(jschomay$elm_narrative_engine$Engine$update, interactableId, model.i);
				var newEngineModel = _n1.a;
				var maybeMatchedRuleId = _n1.b;
				var checkEnd = function () {
					if ((!maybeMatchedRuleId.$) && (maybeMatchedRuleId.a === 'TheEnd')) {
				...
				var narrativeForThisInteraction = {
					aW: author$project$Story$Components$getClassName(
...
var author$project$Port$ImagesLoaded = 0;
var author$project$Port$VoiceLoaded = 1;
var elm$json$Json$Decode$fail = _Json_fail;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Port$decode = function () {
	var decoder = function (command) {
		switch (command) {
			case 'IMAGES_LOADED':
			...
			default:
				return elm$json$Json$Decode$fail('Invalid command received');
		}
	};
...
var author$project$Main$update = F2(
	function (msg, model) {
		var _n0 = _Utils_Tuple2(msg, model.G);
		_n0$7:
		while (true) {
			switch (_n0.a.$) {
				case 0:
				...
				case 7:
					var json = _n0.a.a;
					var _n4 = A2(elm$json$Json$Decode$decodeValue, author$project$Port$decode, json);
					if (!_n4.$) {
						var portMsg = _n4.a;
						if (!portMsg) {
							return _Utils_Tuple2(
...
var author$project$Page$Home$viewStory = function (storyInfo) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$src(storyInfo.ag),
						elm$html$Html$Attributes$alt(storyInfo.ab)
					]),
				_List_Nil)
			]));
};
		...
		aN: A2(
			...
			_List_fromArray(
				[
					...
					A2(elm$core$List$map, author$project$Page$Home$viewStory, model._))
				])),
		ab: 'Story Telling'
	};
};
...
var jschomay$elm_narrative_engine$Engine$getItemsInInventory = function (_n0) {
	var story = _n0;
	return jschomay$elm_narrative_engine$Engine$Manifest$getItemsInInventory(story.aZ);
};
var author$project$Page$Story$getDisplayState = function (model) {
	...
	return {
		S: A2(
			...
			jschomay$elm_narrative_engine$Engine$getCharactersInCurrentLocation(model.i)),
		M: A2(
			author$project$Story$Components$findEntity,
			manifest,
			jschomay$elm_narrative_engine$Engine$getCurrentLocation(model.i)),
		N: jschomay$elm_narrative_engine$Engine$getEnding(model.i),
		ao: A2(
			elm$core$List$map,
			author$project$Story$Components$findEntity(manifest),
			jschomay$elm_narrative_engine$Engine$getItemsInCurrentLocation(model.i)),
		ap: A2(
			elm$core$List$map,
			author$project$Story$Components$findEntity(manifest),
			jschomay$elm_narrative_engine$Engine$getItemsInInventory(model.i)),
		h: model.h
	};
};
...
var author$project$Page$Story$viewCharacters = function (characters) {
					...
					_List_fromArray(
						[
							...
							A2(
								elm$core$Maybe$withDefault,
								'',
								author$project$Story$Components$getImage(character)))
						]),
					_List_Nil)
				]));
	};
...
var author$project$Page$Story$viewStoryLine = F2(
						...
						[
							...
							_List_fromArray(
								[
									...
									(!_Utils_eq(displayState.N, elm$core$Maybe$Nothing)) ? A2(
									elm$html$Html$button,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											...
											author$project$Page$Story$Interact('next'))
										]),
									_List_fromArray(
										[
...
var author$project$Page$Story$view = F2(
	function (voiceLoaded, model) {
		return {
			...
			ab: author$project$Story$getTitle(model.A)
		};
	});
...
var author$project$Main$main = elm$browser$Browser$application(
	{aV: author$project$Main$init, a$: author$project$Main$ChangedUrl, a0: author$project$Main$RequestedUrl, a8: author$project$Main$subscriptions, ba: author$project$Main$update, bc: author$project$Main$view});
